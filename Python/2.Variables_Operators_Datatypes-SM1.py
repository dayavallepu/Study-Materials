...
'''
PEP 8 (Python Enhancement Proposal 8) is the official style guide for writing clean and readable Python code. 
It sets rules for formatting, naming conventions, and best practices.

Key PEP 8 Guidelines
✅ Indentation: Use 4 spaces per indentation level (no tabs).
✅ Line Length: Keep lines ≤79 characters (72 for docstrings).
✅ Blank Lines:
Two blank lines before top-level functions & classes.
One blank line between methods in a class.
✅ Imports:
Import one module per line (import os, import sys).
Order: standard library → third-party → local imports.
✅ Whitespace:
No spaces around = in keyword arguments (func(arg=value)).
One space around operators (x = y + 2).
✅ Naming Conventions:
Variables & functions: snake_case (e.g., my_function)
Constants: UPPER_CASE
Classes: CamelCase (e.g., MyClass)
✅ Docstrings: Use triple quotes ("""Docstring here""") for functions, classes, and modules.
✅ Boolean Comparisons: Use if x is None instead of if x == None.

'''
# PIP (PIP Installs Packages) is the default package manager for Python. It allows you to:
# ✅ Install Python libraries from PyPI (Python Package Index)
# ✅ Update installed packages
# ✅ Uninstall packages
# ✅ Manage dependencies
"""
IPYNB (Interactive Python Notebook) is the file format used by Jupyter Notebook. It stores:

✅ Python code (executable in cells)
✅ Markdown text (for explanations)
✅ Output results (graphs, tables, images)
✅ Metadata (kernel info, cell execution order)
"""

'''
Correct Hierarchy in Python
✅ Modules: Individual .py files containing functions and classes.
✅ Packages: A collection of modules inside a directory with an __init__.py file.
✅ Libraries: A broader term, often referring to a collection of packages or a single large package.
...
# - 'is': Whether two variables refer to the same memory location (object identity), 
...
v='hello world daya'
print(v[:5][-4:])                     #         world (prints 'hello' in one line and 'world' in the next line)
...
print('this is {1:*^10} format {0}'.format('string','daya'))
...
type(Statement)
staement=r' my name is \'bahubali\' im in kattappa '
staement=' my name is \'bahubali\' im in kattappa '
Name = 'Sharat'
...
Num = "this is string example!!!"
Num.upper()  # Output: 'THIS IS STRprintING EXAMPLE!!!'
