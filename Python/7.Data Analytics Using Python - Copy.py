...
#<class 'numpy.ndarray'> ---> output
print(y * 2)  # Prints the result of multiplying each element of 'y' by 2.
#output--->[20 42  6 28 30 32]
y > 10  # Checks which elements of 'y' are greater than 10.output [False  True False  True  True  True]
y[y > 10]  # Retrieves the elements of 'y' that are greater than 10. output [21 14 15 16]
...
# Convert list format into pandas series format
print(df)  # Print the dataframe
