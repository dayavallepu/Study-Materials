...
# for all box plots 
df.plot(kind = 'box', sharey = False, subplots = True, figsize = (10,8))
...
import numpy as np
# Reading data from a CSV file named "ethnic diversity.csv" located at "C:/Data/"
df = pd.read_csv(r"C:\Users\dayav\OneDrive\Desktop\360digiTMG\study materials@360\EDA\EDA-3\InClass_DataPreprocessing_datasets\ethnic diversity.csv")
...
education = pd.read_csv(r"C:\Users\dayav\OneDrive\Desktop\360digiTMG\study materials@360\EDA\EDA-3\InClass_DataPreprocessing_datasets\education.csv")
